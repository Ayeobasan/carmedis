...
import FixCarousel from "../../components/FixCarousel";

const Fixa = () => {
  return (
    <BaseLayout>
      <section className="relative bg-[#045DDA] py-16">
        <div className="md:px-8 xl:px-0 px-4 max-w-[1200px] m-auto ">
          <div className="flex items-center flex-wrap">
            {/* Text Column */}
            <div className="w-full md:w-1/2 px-4 mb-8">
              <h1 className=" text-2xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
                Discover Trusted Mechanics and Schedule Car Care with Confidence
                Using Our App
              </h1>
              <div className="my-4">
                <p className="text-lg text-white">
                  We work on all brands of cars in Lagos State
                </p>
              </div>
            </div>
            {/* Image Column */}
      ...
      <section id="features" className="bg-black px-5 py-12">
        <div
          className=" rounded-[50px]   md:px-8 xl:px-0 px-4 py-5 max-w-[1200px] m-auto"
          style={{
          ...
          <div className="w-full  m-auto">
            <div className="animate__animated animate__zoomOutUp">
              <ul className="flex items-center text-white justify-center space-x-4 mb-8">
                <li className="flex items-center gap-2 border border-[#FFFFFF2B] rounded-full px-4  py-2">
